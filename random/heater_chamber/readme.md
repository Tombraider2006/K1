...
При установке нагревателя, на забывайте о габаритных размерах стола, проверяйте чтобы оставался зазор как от стола до нагревателя, так и от входа вентилятора до стены.
