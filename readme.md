...
[**Датчик филамента sfs 2.0 для k1c**](/sfs/readme.md) когда у нас не просто датчик обрыва филамента а еще с реакцией если филамент остановился. незаменимо при пробках.
